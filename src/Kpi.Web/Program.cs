...
builder.Services.AddSingleton<Kpi.Application.PeriodOperations>();
builder.Services.AddSingleton<Kpi.Application.EvaluationOperations>();
builder.Services.AddSingleton<Kpi.Application.ReconcileKpiLifecycle>();
