...
$required = @('harness.cmd bootstrap', 'KpiManagement.slnx', 'PostgreSQL', 'kpi_lab_test', '/api/v1/formulas/validate', 'formula.ast', 'ActorContext', 'Development', 'separation-of-duty')
